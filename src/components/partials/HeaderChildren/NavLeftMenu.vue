<template>
  <div class="menu">
    ...
    <!-- NOTE voci del menu sx dinamiche -->
    <ul class="links">
      
      <li v-for="(element,index) in menuLeftLinks" :key="index">

        <!-- NOTE solo il link HOME è affiancato da una svg: v-show basato sul valore di "element.icon" di ogni oggetto presente nell'array -->
        <svg v-show="element.icon === 'svg-moustache'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 11"
          class="qodef-moustache">
          <path
