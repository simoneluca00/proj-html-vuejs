<template>
  <div class="menu">
    ...
    <!-- voci del menu sx dinamiche -->
    <ul class="links">
      <li v-for="(element,index) in menuLeftLinks" :key="index">
        <!-- solo il link HOME è affiancato da una svg: v-if rispetto all'elemento.icon di ogni oggetto presente nell'array -->
        <svg v-if="element.icon === 'svg-moustache'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 11"
